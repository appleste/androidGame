...
import com.mygdx.game.tween.Value;
import com.mygdx.game.tween.ValueAccessor;
...
public class GameRenderer {
    ...
    private Animation birdAnimation, deadBirdAnimation;
    ...
    private void initAssets() {
        ...
        deadBirdAnimation = AssetLoader.deadBirdAnimation;
    ...
    private void drawBird(float runTime) {
        ...
        if(bird.isDead()) {
            batcher.draw(deadBirdAnimation.getKeyFrame(runTime), bird.getX(),
                    bird.getY(), bird.getWidth() / 2.0f,
                    bird.getHeight() / 2.0f, bird.getWidth(), bird.getHeight(),
                    1, 1, bird.getRotation());
        }
        else if (bird.shouldntFlap()) {
